...
//            , promoStartAt, promoEndAt, percentCut, minTransaction, maxCut
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addComponent(topUpField, javax.swing.GroupLayout.PREFERRED_SIZE, 102, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(topUpButton, javax.swing.GroupLayout.PREFERRED_SIZE, 89, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(ApplyPromoButton, javax.swing.GroupLayout.PREFERRED_SIZE, 89, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(jumlahSaldo, javax.swing.GroupLayout.PREFERRED_SIZE, 102, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(65, 65, 65)
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                    ...
                                    .addComponent(jumlahSaldo, javax.swing.GroupLayout.PREFERRED_SIZE, 41, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGap(12, 12, 12))
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(layout.createSequentialGroup()
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                        .addComponent(topUpField, javax.swing.GroupLayout.PREFERRED_SIZE, 43, javax.swing.GroupLayout.PREFERRED_SIZE)))
                                .addGap(22, 22, 22)
                                .addComponent(topUpButton, javax.swing.GroupLayout.PREFERRED_SIZE, 31, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(layout.createSequentialGroup()
                                .addGap(18, 18, 18)
    ...
    private void topUpButtonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_topUpButtonMouseClicked
        // TODO add your handling code here:
        String userId = Login.userIDLogin;
        double amount = Double.parseDouble(topUpField.getText());
        HashMap<String, User> users = DataManager.users;
        User user = users.get(userId);
        jumlahSaldo.setText(String.valueOf(user.getBalance()));
        if (users.containsKey(userId)) {
            User member = users.get(userId);
            member.balanceTopup(amount);
            jumlahSaldo.setText(String.valueOf(member.getBalance()));
        } else if (users.containsKey(userId)) {
            User guest = users.get(userId);
            guest.balanceTopup(amount);
            jumlahSaldo.setText(String.valueOf(guest.getBalance()));

        } else {
            System.out.println("TOPUP FAILED: NON EXISTENT CUSTOMER");
        }

    }//GEN-LAST:event_topUpButtonMouseClicked
    ...
    private void finishButtonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_finishButtonMouseClicked
        // TODO add your handling code here:
        dispose();
        CheckoutSucces success = new CheckoutSucces();
